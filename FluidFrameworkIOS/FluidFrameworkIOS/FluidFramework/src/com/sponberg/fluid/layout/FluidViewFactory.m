...
- (void)recycleViewWithNSString:(NSString *)type
  ...
  [((id<FFTFluidViewFactory_FluidViewBuilder>) nil_chk([registeredViewTypes_ getWithId:type])) recycleFluidViewWithId:fluidView withFFTViewPosition:view withId:userInfo];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "recycleViewWithNSString:withId:withFFTViewPosition:withId:", "recycleView", "V", 0x1, NULL },
  ...
  static J2ObjcClassInfo _FFTFluidViewFactory = { "FluidViewFactory", "com.sponberg.fluid.layout", NULL, 0x1, 6, methods, 1, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "recycleFluidViewWithId:withFFTViewPosition:withId:", "recycleFluidView", "V", 0x401, NULL },
    { "cleanupFluidViewWithId:", "cleanupFluidView", "V", 0x401, NULL },
  };
  static J2ObjcClassInfo _FFTFluidViewFactory_FluidViewBuilder = { "FluidViewBuilder", "com.sponberg.fluid.layout", "FluidViewFactory", 0x209, 4, methods, 0, NULL, 0, NULL};
